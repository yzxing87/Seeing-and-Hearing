...
def load_and_transform_video_data(
    ...
    for video_path in video_paths:
        ...
        os.makedirs(f'intermediate/{video_name}', exist_ok=True)
        ...
        for i_time, clip_timepoints in enumerate(all_clips_timepoints):
            ...
            imageio.imwrite(f'intermediate/{video_name}/sampled_frame_{(i_time*2):02d}_0.jpg', video_clip[:, 0, :, :].permute(1, 2, 0).numpy())
        ...
        for i_save in range(len(all_video)):
            imageio.imwrite(f'intermediate/{video_name}/sampled_frame_0_crop_{i_save:02d}.jpg', all_video[i_save][:, 0, :, :].permute(1, 2, 0).numpy())
